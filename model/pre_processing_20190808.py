...
NP_FILE_PATH = BASE_PATH + "/tensorflow/data/"
VOCA_PATH = BASE_PATH + "/tensorflow/data/allvocaset.csv"
DATA_PATH = BASE_PATH + "/tensorflow/data/raw"
            ...
            with open(file, 'r', encoding='UTF-8') as f:
                ...
                for line in lines:
                    for index in range(0, len(line)):
                        ...
                        x_line.append(npIndex(array(list(v)), char, 1))
...
x_data, y_data, v = loadData(folder_names, label_names, voca_arr)
...
np.save(NP_FILE_PATH + 'v' + str(FILE_COUNT), v, allow_pickle=True)
